...
function phpinstall() {
  ...
  if [[ "$ID" == "debian" && $VERSION_ID > 10 ]]; then
    ...
    runCommand "apt -y install php8.4 php8.4-{cli,fpm,common,mysql,zip,gd,mbstring,curl,xml,bcmath}  libapache2-mod-php8.4" "installing php8"
